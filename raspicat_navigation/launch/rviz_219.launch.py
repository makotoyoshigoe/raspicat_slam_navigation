...
def generate_launch_description():
    ...
    map_dir = os.path.join(get_package_share_directory('raspicat_navigation'), 'config', 'map', 'tsudanuma_2_19')
    declare_loc_map_yaml = DeclareLaunchArgument(
        'loc_map', default_value=os.path.join(map_dir, 'localization', 'map_tsudanuma_2_19.yaml'),
        description='Full path to map yaml file for localization to load')
    
    declare_nav_map_yaml = DeclareLaunchArgument(
        'nav_map', default_value=os.path.join(map_dir, 'navigation', 'map_tsudanuma_2_19.yaml'),
    ...
    declare_params_file = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            get_package_share_directory('raspicat_navigation'),
                'config', 'param', 'exp_campus.param.yaml'),
