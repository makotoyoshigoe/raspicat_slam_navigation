...
def generate_launch_description():
    ...
    use_gnss_yaw = LaunchConfiguration('use_gnss_yaw')
    ...
    declare_emcl2_params_file = DeclareLaunchArgument(
        'emcl2_params_file', default_value='',
    ...
    declare_wall_tracking_params_file = DeclareLaunchArgument(
        'wall_tracking_params_file', default_value='',
        description='Full path to the parameters in wall_tracking package to use for all launched nodes')
    ...
    declare_use_gnss_yaw = DeclareLaunchArgument(
        'use_gnss_yaw', default_value='true', 
        description='Whether to use gnss yaw')
    ...
    ld.add_action(declare_wall_tracking_params_file)
    ...
    ld.add_action(declare_use_gnss_yaw)
