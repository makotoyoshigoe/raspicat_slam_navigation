...
def generate_launch_description():
    ...
    map_dir = os.path.join(get_package_share_directory('raspicat_navigation'), 'config', 'map', 'tsudanuma_campus')
    declare_loc_map_yaml = DeclareLaunchArgument(
        'loc_map', default_value=os.path.join(map_dir, 'localization', 'map_tsudanuma_campus.yaml'),
